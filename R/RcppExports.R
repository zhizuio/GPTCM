...
#'
arms_gibbs_zeta <- function(n, nsamp, ninit, minRange, maxRange, metropolis, simple, convex, npoint, currentPars, w0Sq, wSq, kappa, dirichlet, datX, datTheta, datProportionConst, datEvent, weibullS, weibullLambda) {
    .Call('_GPTCM_arms_gibbs_zeta', PACKAGE = 'GPTCM', n, nsamp, ninit, minRange, maxRange, metropolis, simple, convex, npoint, currentPars, w0Sq, wSq, kappa, dirichlet, datX, datTheta, datProportionConst, datEvent, weibullS, weibullLambda)
}
